      ...
      <div className='auth-box' style={{ margin: 0 }}>
        ...
        <div className="account-params">
          <button
            ...
            style={{ 
                    // backgroundColor: signUpTab ? "rgb(245, 245, 245)" : "",
        ...
        {signUpTab && detectSave ?
          <p>Créer un compte pour sauvegarder ce projet. Une fois votre email vérifier, vous pourrez vous connecter et retrouver dans votre compte votre projet sauvegardé.</p> 
        : !signUpTab && detectSave ?
          <p>Connectez-vous à votre compte pour sauvegarder ce projet.</p>
        : signUpTab && detectModel ?
          <p>Créer un compte pour visualiser le cash-flow annuel net d'impôt de ce projet sur toute la durée de l'emprunt. Les paramètres saisis seront automatiquement sauvegardés. Une fois votre email vérifier, vous pourrez vous connecter à votre compte et consulter le cash-flow annuel net d'impôt de votre projet.</p> 
        : !signUpTab && detectModel ?
        ...
        <p>Créer un compte pour visualiser le cash-flow annuel net d'impôt d'un projet sur toute la durée de l'emprunt et sauvegarder les paramètres de tous vos projets à l'étude.</p>
        : !signUpTab && !detectModel && !detectSave ?
        <p>Connectez-vous à votre compte pour visualiser le cash-flow annuel net d'impôt d'un projet sur toute la durée de l'emprunt et sauvegarder les paramètres de tous vos projets à l'étude.</p>
        :  ""}
        {signUpTab ?
        <form
          className="auth-form"
        ...
        >
          ...
          <div className='auth-box-end'>
            <input 
              ...
              required
              />
            <p>Accepter que Simulimo transmette mes informations à ses partenaires à des fins commerciales. <b>Vous pourrez changer d'avis à tout moment.</b> <a href="/confidentialite" target='_blank'>En savoir plus</a></p>
          </div>
