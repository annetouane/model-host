  ...
  return (
    ...
    >
      ...
      <div className='form-group'>
        <div
          className={
            width < 770 ? "form-box-v-half mt-10" : "form-box-v-half mt-10 mr-5"
          }
        >
        ...
        >
          <div className='apport'>
            ...
            <input
              ...
              onChange={onChange}
              className={
                isNaN(parseInt(apport))
                  ? "input-box-false fs-12"
                  : "input-box fs-12"
              }
            />
          </div>
          {apport > coutProjet && netVendeur !== 0 ? (
            <small
              style={{ marginTop: "5px", color: "#007be8", fontWeight: "bold" }}
            >
              <i
                style={{
                  marginLeft: "0",
      ...
      <div className='form-group'>
        ...
        <div
          className={
            width < 770 ? "form-box-v-half mt-10" : "form-box-v-half mt-10 ml-5"
          }
        >
          <div className='type-alt-slider'>
            <div style={{ width: "100%" }} className='flex-row jc-sb ai-fc'>
            ...
            <div className='flex-column'>
              ...
              {emprunt ? (
                <small>
                  soit{" "}
                  {Math.round(
                    ((fraisBancaires / emprunt) * 100 + Number.EPSILON) * 100
                  ) / 100}{" "}
                  % du capital emprunté
                </small>
              ) : (
            ...
            <div className='flex-column'>
              ...
              {emprunt ? (
                <small>
                  soit{" "}
                  {Math.round(
                    ((fraisCourtier / emprunt) * 100 + Number.EPSILON) * 100
                  ) / 100}{" "}
                  % du capital emprunté
                </small>
              ) : (
