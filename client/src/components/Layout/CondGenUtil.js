  ...
  return (
    <section className='information-page'>
      ...
      <p>
        ...
        du site et des services par Simulimo et de définir les conditions
      ...
      <p>
        ...
        précédant le texte suivant : « je reconnais avoir pris connaissance des
        conditions générales d'utilisation et je les accepte ».
      </p>
      <p>
        En cas de non-acceptation des CGU stipulées dans le présent contrat,
        l'Utilisateur se doit de renoncer à l'accès aux services proposés par le
        site. simulimo.com se réserve le droit de modifier unilatéralement et à
        tout moment le contenu des présentes CGU.
      </p>
      <h3>Article 1 : Les mentions légales</h3>
      <p>
        L’édition et la direction de la publication du site simulimo.com est
        assurée par Antoine CHARDIGNY, domicilié au 44 boulevard Gouvion Saint
        Cyr, 75017, Paris, France. Adresse e-mail : simulimo@gmail.com
      </p>
      <p>
        L'hébergeur du site simulimo.com est la société Heroku Inc., dont le
        siège social est situé au 650 7th Street, San Francisco, CA, avec le
        numéro de téléphone : 1 (877) 563-4311.
      </p>
      <h3>ARTICLE 2 : Accès au site</h3>
      <p>
        Le site simulimo.com permet à l'Utilisateur un accès gratuit au service
        de modélisation de la rentabilité de projet d’investissement locatif.{" "}
      </p>
      <p>
      ...
      <p>
        L’Utilisateur non membre n'a pas accès aux services réservés (sauvegarde
        projet et calcul du cash-flow après impôts). Pour cela, il doit
        s’inscrire en remplissant le formulaire prévu à cet effet. En acceptant
      ...
      <p>
        ...
        solliciter sa désinscription en se rendant à la page Mon Compte sur son
      ...
      <p>
        ...
        responsabilité de simulimo.com. Dans ces cas, l’Utilisateur accepte
      ...
      <ul>
        <li>par mail à l'adresse mail simulimo@gmail.com</li>
        <li>par voie postale au 44 boulevard Gouvion Saint Cyr</li>
      </ul>
      ...
      <p>
        Les informations diffusées sur le site simulimo.com sont réputées
      ...
      <p>
        ...
        le site simulimo.com ne peut être tenu responsable de la modification
      ...
      <p>
        Le site simulimo.com ne peut être tenu pour responsable d’éventuels
      ...
      <p>
        ...
        simulimo.com. Ce dernier n’a pas de contrôle sur les pages web sur
      ...
      <p>
        ...
        nécessaires à l’utilisation du site simulimo.com. Les cookies ne
...
CondGenUtil.propTypes = {
  passwordChangePage: PropTypes.func.isRequired,
};

export default connect(null, { passwordChangePage })(CondGenUtil);
