...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    array.forEach((item, i) => {
      return item.annee = i + 1, // à mettre au début de chaque objet
             ...
             item.chargesExpl = item.gestionLoc + item.chargesCour + item.taxeFonc + item.pno,
            ...
            item.sciLmnpChargesDeduc = item.annee == 1 ? item.chargesFi + item.chargesExpl + item.amImmeuble + item.amTravaux + item.amAmmeublement + item.amFraisAcq + fraisBancaires : item.chargesFi + item.chargesExpl + item.amImmeuble + item.amTravaux + item.amAmmeublement + item.amFraisAcq,
            item.sciLmnpDefFoncier = sciLmnpPrevious,
            sciLmnpPrevious = item.sciLmnpDefFoncier + item.sciLmnpChargesDeduc - item.loyer < 0 ? 0 : item.sciLmnpDefFoncier + item.sciLmnpChargesDeduc - item.loyer,
            
            // calcul déficit foncier en location nue au réel + déduction impôts revenu activité
            item.nueReelDeducRevAct = item.annee == 1 && travaux + item.chargesFi + item.chargesExpl - item.loyer >= 10700 ? 10700
              : item.annee == 1 && travaux + item.chargesFi + item.chargesExpl - item.loyer < 10740 && item.annee == 1 && travaux + item.chargesFi + item.chargesExpl - item.loyer > 0 ? travaux + item.chargesFi + item.chargesExpl - item.loyer : 0,
            item.nueChargesDeduc = item.annee == 1 ? item.chargesFi + item.chargesExpl + travaux - item.nueReelDeducRevAct : item.chargesFi + item.chargesExpl,
            item.nueDefFoncier = nuePrevious,
            nuePrevious = item.nueDefFoncier + item.nueChargesDeduc - item.loyer < 0 ? 0 : item.nueDefFoncier + item.nueChargesDeduc - item.loyer,

            // revenu d'activité imposable 
            item.revActImp = (revInvest1 * Math.pow(1 + augInvest1, item.annee-1) + revInvest2 * Math.pow(1 + augInvest2, item.annee-1)) * 0.9,
            ...
            item.a2 = item.a1 < 10084 ? 0
             : item.a1 > 10085 && item.a1 <= 25710 ? (item.a1 - 10084) * 0.11
             : item.a1 > 25710 && item.a1 <= 73516 ? (item.a1 - 25710) * 0.30 + 1721.06
             : item.a1 > 73516 && item.a1 <= 158122  ? (item.a1 - 73516) * 0.41 + 16062.86
             : item.a1 > 158122 ? (item.a1 - 158122) * 0.45 + 50751.32 : 0,
            item.a3 = revInvest2 == 0 ? item.a2 : item.a2 * 2,

            // plafonnement parts supplémentaires et revenu d'activité imposable
            item.plafonnement = revInvest2 == 0 ? (partFisc - 1) / 0.25 * 784 : (partFisc - 2) / 0.25 * 784,
            ...
            item.b2 = item.b1 < 10084 ? 0
             : item.b1 > 10085 && item.b1 <= 25710 ? (item.b1 - 10084) * 0.11
             : item.b1 > 25710 && item.b1 <= 73516 ? (item.b1 - 25710) * 0.30 + 1721.06
             : item.b1 > 73516 && item.b1 <= 158122  ? (item.b1 - 73516) * 0.41 + 16062.86
             : item.b1 > 158122 ? (item.b1 - 158122) * 0.45 + 50751.32 : 0,
            ...
            item.impotRevAct = item.a3 - item.b3 > item.plafonnement ? item.a3 - item.plafonnement : item.b3,
            ...
            item.lmnpReelRevFoncImp = item.loyer - item.sciLmnpChargesDeduc - item.sciLmnpDefFoncier <= 0 ? 0 : item.loyer - item.sciLmnpChargesDeduc - item.sciLmnpDefFoncier,
            ...
            item.lmnpReelC1 = revInvest2 == 0 ? item.lmnpReelRevTotImp : item.lmnpReelRevTotImp / 2,
            item.lmnpReelC2 = item.lmnpReelC1 < 10084 ? 0
              : item.lmnpReelC1 > 10085 && item.lmnpReelC1 <= 25710 ? (item.lmnpReelC1 - 10084) * 0.11
              : item.lmnpReelC1 > 25710 && item.lmnpReelC1 <= 73516 ? (item.lmnpReelC1 - 25710) * 0.30 + 1721.06
              : item.lmnpReelC1 > 73516 && item.lmnpReelC1 <= 158122  ? (item.lmnpReelC1 - 73516) * 0.41 + 16062.86
              : item.lmnpReelC1 > 158122 ? (item.lmnpReelC1 - 158122) * 0.45 + 50751.32 : 0,
            item.lmnpReelC3 = revInvest2 == 0 ? item.lmnpReelC2 : item.lmnpReelC2 * 2,
            ...
            item.lmnpReelD2 = item.lmnpReelC1 < 10084 ? 0
              : item.lmnpReelD1 > 10085 && item.lmnpReelD1 <= 25710 ? (item.lmnpReelD1 - 10084) * 0.11
              : item.lmnpReelD1 > 25710 && item.lmnpReelD1 <= 73516 ? (item.lmnpReelD1 - 25710) * 0.30 + 1721.06
              : item.lmnpReelD1 > 73516 && item.lmnpReelD1 <= 158122  ? (item.lmnpReelD1 - 73516) * 0.41 + 16062.86
              : item.lmnpReelD1 > 158122 ? (item.lmnpReelD1 - 158122) * 0.45 + 50751.32 : 0,
            item.lmnpReelD3 = item.lmnpReelD2 * partFisc,

            // calcul impôts sur le revenu d'ACTIVITE en prennant en compte le plafonnement 
            // de la réduction d'impot liée aux parts supplémentaire 
            item.lmnpReelImpotRevTot = item.lmnpReelC3 - item.lmnpReelD3 > item.plafonnement ? item.lmnpReelC3 - item.plafonnement : item.lmnpReelD3,
            ...
            // C2 = calcul de l'impôt sur le revenu pour chaque part fiscal
            // C3 = calcul de l'impôt total à payer
            item.lmnpMicroC1 = revInvest2 == 0 ? item.lmnpMicroRevTotImp : item.lmnpMicroRevTotImp / 2,
            item.lmnpMicroC2 = item.lmnpMicroC1 < 10084 ? 0
              : item.lmnpMicroC1 > 10085 && item.lmnpMicroC1 <= 25710 ? (item.lmnpMicroC1 - 10084) * 0.11
              : item.lmnpMicroC1 > 25710 && item.lmnpMicroC1 <= 73516 ? (item.lmnpMicroC1 - 25710) * 0.30 + 1721.06
              : item.lmnpMicroC1 > 73516 && item.lmnpMicroC1 <= 158122  ? (item.lmnpMicroC1 - 73516) * 0.41 + 16062.86
              : item.lmnpMicroC1 > 158122 ? (item.lmnpMicroC1 - 158122) * 0.45 + 50751.32 : 0,
            item.lmnpMicroC3 = revInvest2 == 0 ? item.lmnpMicroC2 : item.lmnpMicroC2 * 2,
            ...
            item.lmnpMicroD2 = item.lmnpMicroD1 < 10084 ? 0
              : item.lmnpMicroD1 > 10085 && item.lmnpMicroD1 <= 25710 ? (item.lmnpMicroD1 - 10084) * 0.11
              : item.lmnpMicroD1 > 25710 && item.lmnpMicroD1 <= 73516 ? (item.lmnpMicroD1 - 25710) * 0.30 + 1721.06
              : item.lmnpMicroD1 > 73516 && item.lmnpMicroD1 <= 158122  ? (item.lmnpMicroD1 - 73516) * 0.41 + 16062.86
              : item.lmnpMicroD1 > 158122 ? (item.lmnpMicroD1 - 158122) * 0.45 + 50751.32 : 0,
            ...
            // revenu foncier imposable et revenu total (activité + foncier) imposable
            item.nueReelRevFoncImp = item.loyer - item.nueChargesDeduc - item.nueDefFoncier <= 0 ? 0 : item.loyer - item.nueChargesDeduc - item.nueDefFoncier,
            item.nueReelRevTotImp = item.revActImp + item.nueReelRevFoncImp - item.nueReelDeducRevAct,
            
            // C) impôt sur le d'ACTIVITE + FONCIER - SANS parts de quotien familial supplémentaires
            // C1 = quotien familial sans parts de quotien familial supplémentaire (parts des enfants)
            // C2 = calcul de l'impôt sur le revenu pour chaque part fiscal
            // C3 = calcul de l'impôt total à payer
            item.nueReelC1 = revInvest2 == 0 ? item.nueReelRevTotImp : item.nueReelRevTotImp / 2,
            item.nueReelC2 = item.nueReelC1 < 10084 ? 0
              : item.nueReelC1 > 10085 && item.nueReelC1 <= 25710 ? (item.nueReelC1 - 10084) * 0.11
              : item.nueReelC1 > 25710 && item.nueReelC1 <= 73516 ? (item.nueReelC1 - 25710) * 0.30 + 1721.06
              : item.nueReelC1 > 73516 && item.nueReelC1 <= 158122  ? (item.nueReelC1 - 73516) * 0.41 + 16062.86
              : item.nueReelC1 > 158122 ? (item.nueReelC1 - 158122) * 0.45 + 50751.32 : 0,
            item.nueReelC3 = revInvest2 == 0 ? item.nueReelC2 : item.nueReelC2 * 2,
            ...
            item.nueReelD2 = item.nueReelD1 < 10084 ? 0
              : item.nueReelD1 > 10085 && item.nueReelD1 <= 25710 ? (item.nueReelD1 - 10084) * 0.11
              : item.nueReelD1 > 25710 && item.nueReelD1 <= 73516 ? (item.nueReelD1 - 25710) * 0.30 + 1721.06
              : item.nueReelD1 > 73516 && item.nueReelD1 <= 158122  ? (item.nueReelD1 - 73516) * 0.41 + 16062.86
              : item.nueReelD1 > 158122 ? (item.nueReelD1 - 158122) * 0.45 + 50751.32 : 0,
            item.nueReelD3 = item.nueReelD2 * partFisc,

            // calcul impôts sur le revenu d'ACTIVITE en prennant en compte le plafonnement 
            // de la réduction d'impot liée aux parts supplémentaire 
            item.nueReelImpotRevTot = item.nueReelC3 - item.nueReelD3 > item.plafonnement ? item.nueReelC3 - item.plafonnement : item.nueReelD3,
            ...
            // C2 = calcul de l'impôt sur le revenu pour chaque part fiscal
            // C3 = calcul de l'impôt total à payer
            item.nueMicroC1 = revInvest2 == 0 ? item.nueMicroRevTotImp : item.nueMicroRevTotImp / 2,
            item.nueMicroC2 = item.nueMicroC1 < 10084 ? 0
              : item.nueMicroC1 > 10085 && item.nueMicroC1 <= 25710 ? (item.nueMicroC1 - 10084) * 0.11
              : item.nueMicroC1 > 25710 && item.nueMicroC1 <= 73516 ? (item.nueMicroC1 - 25710) * 0.30 + 1721.06
              : item.nueMicroC1 > 73516 && item.nueMicroC1 <= 158122  ? (item.nueMicroC1 - 73516) * 0.41 + 16062.86
              : item.nueMicroC1 > 158122 ? (item.nueMicroC1 - 158122) * 0.45 + 50751.32 : 0,
            item.nueMicroC3 = revInvest2 == 0 ? item.nueMicroC2 : item.nueMicroC2 * 2,
            ...
            item.nueMicroD2 = item.nueMicroD1 < 10084 ? 0
              : item.nueMicroD1 > 10085 && item.nueMicroD1 <= 25710 ? (item.nueMicroD1 - 10084) * 0.11
              : item.nueMicroD1 > 25710 && item.nueMicroD1 <= 73516 ? (item.nueMicroD1 - 25710) * 0.30 + 1721.06
              : item.nueMicroD1 > 73516 && item.nueMicroD1 <= 158122  ? (item.nueMicroD1 - 73516) * 0.41 + 16062.86
              : item.nueMicroD1 > 158122 ? (item.nueMicroD1 - 158122) * 0.45 + 50751.32 : 0,
            item.nueMicroD3 = item.nueMicroD2 * partFisc,

            // calcul impôts sur le revenu d'ACTIVITE en prennant en compte le plafonnement 
            // de la réduction d'impot liée aux parts supplémentaire 
            item.nueMicroImpotRevTot = item.nueMicroC3 - item.nueMicroD3 > item.plafonnement ? item.nueMicroC3 - item.plafonnement : item.nueMicroD3,
